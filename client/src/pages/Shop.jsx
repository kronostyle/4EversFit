...
export default function Shop() {
  ...
  // Función reutilizable para renderizar las tarjetas de producto
    ...
    <div key={product.id} className="group cursor-pointer flex flex-col">
      ...
      <div className="relative aspect-[3/4] bg-zinc-900 rounded-2xl overflow-hidden mb-5 border border-white/5 group-hover:border-lime-400/30 transition-colors">
        ...
        <div className="absolute inset-0 bg-zinc-950/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center p-6">
          <button className="w-full py-4 bg-lime-400 text-zinc-950 font-black text-xs uppercase tracking-widest rounded-xl translate-y-4 group-hover:translate-y-0 transition-all shadow-lg hover:bg-white hover:text-zinc-950">
            Añadir al Carrito
          </button>
        </div>
      </div>
        ...
        <section className="grid md:grid-cols-2 gap-6">
          ...
          <div className="relative h-[400px] rounded-3xl overflow-hidden border border-white/10 group cursor-pointer">
            ...
            <div className="absolute bottom-10 left-10 right-10">
              ...
              <button className="px-6 py-3 bg-white text-zinc-950 text-xs font-black uppercase tracking-widest rounded-xl hover:bg-lime-400 transition-colors">
                Ver Colección
              </button>
            </div>
          </div>
